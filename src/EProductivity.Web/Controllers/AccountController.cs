...
namespace EProductivity.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public EProductivityUserManager UserManager {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<EProductivityUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        private async Task SignInAsync(EProductivityUser user, bool isPersistent)
        {
